...
var axios = require('axios'); //Used to call Bands in Town, Spotify and OMDB APIs
var fs = require('fs');
...
function concert(search){
    ...
    function(response) {
            ...
            for(var i = 0; i < response.data.length; i++){
                // Print out the Name of the venue, Venue location, Date of the Event (use moment to format this as "MM/DD/YYYY")
